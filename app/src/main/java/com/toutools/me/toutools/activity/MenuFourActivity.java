...
public class MenuFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_four);


        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(MenuFourActivity.this));

        progressDialog = new ProgressDialog(MenuFourActivity.this);
        ...
        Query query = databaseRef.child("Post")
                .orderByChild("category").equalTo("ช่างไฟฟ้า");
